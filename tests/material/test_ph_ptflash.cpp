 ...
 *
 * Cases are data-driven: a FlashCase struct (ph_mvp_fixtures.hh) carries the
...
#define BOOST_TEST_MODULE PhMvpPtFlash
...
using Opm::PhMvpTest::ExpectedPhase;
using Opm::PhMvpTest::FlashCase;
using Opm::PhMvpTest::FlashResult;
...
using Opm::PhMvpTest::f2Temperature;
