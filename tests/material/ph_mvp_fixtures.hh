 ...
 * \file
 *
 * \brief Test-local fixtures for the P-H (isenthalpic) flash test suite:
 ...
 * assertions live in the test files. Suite convention: one file per stage,
 * named tests/material/test_ph_<stage>.cpp with BOOST_TEST_MODULE
 * PhMvp<Stage>; shared, Boost-free helpers go here.
 */
#ifndef OPM_PH_MVP_FIXTURES_HH
#define OPM_PH_MVP_FIXTURES_HH
 ...
 *
 * Test-local: lives in the PhMvpTest namespace on purpose; it is a fixture,
 * not installable API.
 */
...
/*!
 * \brief The Evaluation type the ph_mvp suite runs PTFlash with.
 *
